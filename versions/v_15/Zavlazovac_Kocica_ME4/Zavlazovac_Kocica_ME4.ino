...
void prace_s_vystupy() {
  ...
  if (!soucasnyBeh) {
    ...
    for (i = 0; i <= 6; i++) {
      if ((hodiny == dny[i].hodinycelk) && (minuty == dny[i].minutycelk) && (!soucasnyBehVystupy) && (AN2 < nastvlhkosti) && (AN1 > nasthladiny) && (denVTydnu == (i + 1)) && ((dny[0].min1celk > 0) || (dny[0].min2celk > 0))) {
        nacitaniVstupu = true;
