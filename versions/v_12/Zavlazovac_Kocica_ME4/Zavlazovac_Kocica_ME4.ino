...
void setup() {
  ...
  */
  ...
  //zapisORC(0,0,0,0,0);                        // formát (vteřiny,minuty,hodiny,denVTydnu,denVMesici) - nastavení Obvodu Reálného Času, při deklaraci smazat poznámku (//) mimochodem čas lze nastavit i ručně, vpravo dole
...
void loop() {
  ...
  if  (zhasnuti >= limitdisplaye) {
    lcd.noBacklight();                                                                                // vypnutí podsvícení displaye po uplynutí nastaveného času bez stlačení tlačítka
  }
